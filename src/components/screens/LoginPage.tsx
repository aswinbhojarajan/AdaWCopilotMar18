    ...
    <div className="h-full w-full bg-[#efede6] overflow-y-auto">
      <div className="flex flex-col items-center px-[24px] pt-[60px] pb-[40px] min-h-full">
        ...
        <div className="w-full bg-white rounded-[30px] px-[24px] py-[24px] mb-[20px]">
          <form onSubmit={handleSubmit} className="flex flex-col gap-[16px]">
            <div className="flex flex-col gap-[6px]">
              <label
                className="font-['DM_Sans:SemiBold',sans-serif] text-[10px] tracking-[0.8px] uppercase text-[#992929]"
              >
                EMAIL
              </label>
              <input
                ...
                className="w-full h-[44px] px-[16px] rounded-[50px] border-[0.75px] border-[#d8d8d8] bg-[#f7f6f2] font-['DM_Sans:Regular',sans-serif] text-[14px] text-[#555555] outline-none focus:border-[#441316] transition-colors placeholder:text-[#999]"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full h-[44px] rounded-[50px] bg-[#441316] text-white font-['DM_Sans:Regular',sans-serif] text-[14px] tracking-[-0.28px] hover:bg-[#5a1a1e] active:bg-[#331012] transition-colors cursor-pointer mt-[8px]"
            >
              Sign In
            </button>
          </form>
        ...
        <div className="w-full">
          ...
          >
            <span className="font-['DM_Sans:SemiBold',sans-serif] text-[10px] tracking-[0.8px] uppercase text-[#999]">
              Dev Quick Access
            </span>
            <svg
              width="12"
            ...
            <div className="w-full rounded-[30px] border-[1.5px] border-dashed border-[#d8d8d8] bg-white/50 px-[16px] py-[16px]">
              {isLoading ? (
                <div className="flex items-center justify-center py-[20px]">
                  <p className="font-['DM_Sans:Light',sans-serif] text-[12px] text-[#999]">
                    Loading personas...
                  </p>
                </div>
              ) : (
                  ...
                  {personas.map((persona) => (
                    ...
                    >
                      <div className="w-[36px] h-[36px] rounded-full bg-[#441316] flex items-center justify-center shrink-0">
                        <span className="text-white text-[12px] font-['DM_Sans:Medium',sans-serif]">
                          {persona.firstName.charAt(0)}{persona.lastName.charAt(0)}
                        </span>
                      </div>
                      <div className="flex flex-col gap-[2px] flex-1 min-w-0">
                        <p className="font-['Crimson_Pro:Regular',sans-serif] text-[16px] tracking-[-0.32px] text-[#555555] group-hover:text-[#441316] transition-colors">
                          {persona.firstName} {persona.lastName}
                        </p>
                        <div className="flex items-center gap-[8px]">
                          <span
                            className="font-['DM_Sans:Regular',sans-serif] text-[10px] tracking-[0.2px] uppercase px-[6px] py-[1px] rounded-[50px]"
                            style={{
                          ...
                          <span className="font-['DM_Sans:Regular',sans-serif] text-[11px] text-[#888]">
