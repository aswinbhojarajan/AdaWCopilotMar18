...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="h-full w-full bg-[#efede6] overflow-y-auto">
      <div className="flex flex-col items-center pb-[40px] min-h-full pt-safe" style={{ paddingLeft: 'var(--container-pad)', paddingRight: 'var(--container-pad)', paddingBottom: 'calc(2.5rem + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <div className="w-full bg-white rounded-[30px] px-[24px] py-[24px] mb-[20px]">
          <form onSubmit={handleSubmit} className="flex flex-col gap-[16px]">
            ...
            <button
              type="submit"
              className="w-full h-[48px] rounded-[50px] bg-[#441316] text-white font-['DM_Sans',sans-serif] text-[0.875rem] tracking-[-0.28px] hover:bg-[#5a1a1e] active:bg-[#331012] transition-colors cursor-pointer mt-[8px]"
            >
              Sign In
            </button>
          </form>
        ...
        <div className="w-full">
          ...
          >
            <span className="font-['DM_Sans',sans-serif] font-semibold text-[0.625rem] tracking-[0.8px] uppercase text-[#999]">
              Dev Quick Access
            </span>
            <svg
              width="12"
            ...
            <div className="w-full rounded-[30px] border-[1.5px] border-dashed border-[#d8d8d8] bg-white/50 px-[16px] py-[16px]">
              {isLoading ? (
                <div className="flex items-center justify-center py-[20px]">
                  <p className="font-['DM_Sans',sans-serif] font-light text-[0.75rem] text-[#999]">
                    Loading personas...
                  </p>
                </div>
              ) : (
