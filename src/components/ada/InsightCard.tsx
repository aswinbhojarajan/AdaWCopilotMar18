...
export function InsightCard({
  ...
  children,
  timestamp,
  buttonText: _buttonText = 'Ask Ada',
        ...
        <div className="content-stretch flex flex-col gap-[24px] items-start pb-[24px] pt-[16px] px-[24px] relative w-full">
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full">
              <div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
                <p className="font-['DM_Sans',sans-serif] font-semibold h-[12px] leading-[18px] not-italic relative shrink-0 text-[#992929] text-[0.625rem] text-center tracking-[0.8px] uppercase">
                  {type === 'INSIGHT'
            ...
            <p className="font-['Crimson_Pro',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#555555] text-[1.5rem] text-center tracking-[-0.48px] w-[277px]">
              {title}
            </p>

            {description && (
              <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#555555] text-[0.875rem] text-center tracking-[-0.28px] w-[273px]">
                {description}
              </p>
            )}
          </div>
          ...
          {timestamp && (
            <div className="bg-white h-[40px] relative rounded-bl-[32px] rounded-br-[32px] shrink-0 w-full -mx-[24px] -mb-[24px]">
              <div
                aria-hidden="true"
                className="absolute border-[#d8d8d8] border-[0.5px_0px_0px] border-solid inset-0 pointer-events-none rounded-bl-[32px] rounded-br-[32px]"
              />
