...
import { Clock, AlertTriangle, Lightbulb, Newspaper, Calendar, FileText, TrendingUp, Bell } from 'lucide-react';
...
const notificationConfig: Record<NotificationType, { accentColor: string; icon: any; bgColor: string }> = {
  'PORTFOLIO_ALERT': {
    accentColor: '#d97706',
    icon: AlertTriangle,
    bgColor: '#fef3c7'
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex items-center gap-[8px]">
        {unread && (
          <div className="h-[8px] w-[8px] rounded-full bg-[#992929] shrink-0" />
        )}
        <p 
          className="font-['Crimson_Pro:ExtraLight',sans-serif] text-[#3a3a3a] text-[18px] leading-[24px] flex-1"
        >
          {title}
        </p>
      </div>
