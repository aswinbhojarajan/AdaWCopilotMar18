...
export function Button({ 
  ...
  const baseStyles = "content-stretch flex items-center justify-center relative rounded-[50px] shrink-0";
  ...
  const textColor = (variant === 'primary' || variant === 'ai-primary') ? 'text-white' : 'text-[#555555]';
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-[6px] items-center justify-center">
        ...
        <p className={`${(variant === 'primary' || variant === 'ai-primary') ? "font-['DM_Sans:SemiBold',sans-serif]" : "font-['DM_Sans:Regular',sans-serif]"} not-italic relative shrink-0 ${textColor} text-[12px] text-nowrap whitespace-pre`}>
          {children}
        </p>
      </div>
    </button>
