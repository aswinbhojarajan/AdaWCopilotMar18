        ...
        <>
          ...
          >
            <div className="px-[20px] pt-[16px] pb-[8px] flex items-center justify-between border-b border-[#e3e3e3]">
              <h2 className="font-['Crimson_Pro',serif] font-semibold text-[1.25rem] text-[#2E3A59] tracking-[-0.4px]">
                Switch Persona
              </h2>
              <button
                onClick={onClose}
                    ...
                    return (
                      ...
                      >
                        <div className={`w-[42px] h-[42px] rounded-full ${colorClass} flex items-center justify-center shrink-0`}>
                          <span className="text-white font-['DM_Sans',sans-serif] font-medium text-[0.875rem]">
                            {getInitials(persona.firstName, persona.lastName)}
                          </span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-[8px]">
                            <span className="font-['DM_Sans',sans-serif] font-medium text-[0.9375rem] text-[#2E3A59] truncate">
                              {persona.firstName} {persona.lastName}
                            </span>
                            {isActive && (
                              <span className="text-[0.6875rem] font-['DM_Sans',sans-serif] font-medium text-[#441316] bg-[#441316]/10 px-[6px] py-[1px] rounded-full shrink-0">
                                Active
                              </span>
                            )}
                          </div>
                          <div className="flex items-center gap-[8px] mt-[2px]">
                            <span className={`text-[0.6875rem] font-['DM_Sans',sans-serif] font-medium px-[6px] py-[1px] rounded-full ${risk.bg} ${risk.text}`}>
                              {risk.label}
                            </span>
                            <span className="font-['DM_Sans',sans-serif] text-[0.75rem] text-[#888]">
