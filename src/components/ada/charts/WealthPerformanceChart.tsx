      ...
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
        ...
        {(title || summaryMetric) && (
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
            {title && (
              <p className="font-['RL_Limo:Regular',sans-serif] not-italic relative shrink-0 text-[#992929] text-[10px] tracking-[0.2px] uppercase">
                {title}
              </p>
            )}
          </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      {(title || summaryMetric) && (
        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
          {title && (
            <p className="font-['DM_Sans:SemiBold',sans-serif] not-italic relative shrink-0 text-[rgba(85,85,85,0.8)] text-[10px] tracking-[0.8px] uppercase">
              {title}
            </p>
          )}
          {summaryMetric && (
        ...
        {hoveredPoint !== null && (
          ...
          >
            <div className="bg-[#a87174] rounded-[8px] px-[10px] py-[6px] shadow-lg">
              <p className="font-['DM_Sans:SemiBold',sans-serif] text-white text-[11px] leading-tight whitespace-nowrap">
                {formatValue(displayedPoint.value)}
              </p>
              <p className="font-['DM_Sans:Regular',sans-serif] text-white text-[9px] opacity-70 leading-tight whitespace-nowrap">
