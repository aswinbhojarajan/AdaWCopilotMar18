        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start pb-[24px] pt-[16px] px-[24px] relative w-full">
          ...
          <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
            <div className="content-stretch flex items-end justify-between not-italic relative shrink-0 w-full">
              <div className="flex flex-col font-['DM_Sans',sans-serif] h-[7px] justify-center leading-[0] relative shrink-0 text-[#555555] text-[0.5625rem] w-[75px]">
              ...
              <p className="font-['DM_Sans',sans-serif] h-[17px] leading-[28px] relative shrink-0 text-[#555555] text-[0.5625rem] text-right w-[75px]">
                {title}
              </p>
            </div>
          ...
          {/* Subtitle */}
          <div className="font-['Crimson_Pro',sans-serif] font-normal leading-[0] relative shrink-0 text-[#555555] text-[1.125rem] text-center tracking-[-0.36px] w-full">
          ...
          {/* Sub bodycopy */}
          {showSubBodycopy && (
            <p className="font-['DM_Sans',sans-serif] leading-[normal] relative shrink-0 text-[#555555] text-[0.875rem] text-center opacity-60 w-full">
