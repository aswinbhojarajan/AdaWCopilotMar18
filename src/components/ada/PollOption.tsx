...
export function PollOption({
    ...
    return (
      <div className="content-stretch flex flex-col gap-[4px] relative shrink-0 w-full">
        <div className="flex items-center justify-between">
          ...
          <p
            className={`font-['DM_Sans',sans-serif] font-medium text-[0.75rem] ${isUserSelection ? 'text-[#992929]' : 'text-[#555555] opacity-60'}`}
          >
            {percentage}%
          </p>
        </div>
  ...
  return (
    <label className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full cursor-pointer group">
      ...
      />
      <p className="font-['DM_Sans',sans-serif] leading-[normal] text-[#555555] text-[0.875rem] group-hover:text-[#992929] transition-colors">
        {label}
      </p>
    </label>
  );
