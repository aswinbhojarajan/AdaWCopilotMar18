          ...
          <div className="flex items-start gap-[12px] w-full">
            ...
            <div className="flex-1 flex flex-col gap-[8px] min-w-0">
              <div className="flex items-start justify-between gap-[8px]">
                <p className="font-['DM_Sans',sans-serif] font-semibold text-[#555555] text-[0.875rem] leading-[1.3]">
                  {prompt.title}
                </p>
                <button
              ...
              <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.8125rem] opacity-60 leading-[1.4]">
                {prompt.description}
              </p>
