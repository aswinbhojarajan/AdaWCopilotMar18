        ...
        <div className="content-stretch flex flex-col items-start pb-[20px] pt-[16px] px-[24px] relative w-full">
          ...
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full mb-[16px]">
            <div className="flex flex-col gap-[2px]">
              ...
              <p className="font-['Crimson_Pro',sans-serif] relative shrink-0 text-[#555555] text-[1.25rem] tracking-[-0.4px]">
                Portfolio breakdown
              </p>
            </div>
            ...
            >
              <p className="font-['DM_Sans',sans-serif] text-[0.75rem]">
                ...
                return (
                  <div key={index} className="flex items-start justify-between">
                    <div className="flex items-center gap-[8px]">
                      ...
                      />
                      <p className="font-['DM_Sans',sans-serif] text-[0.8125rem] text-[#555555] tracking-[-0.26px]">
                        {allocation.label}
                      </p>
                    </div>
