          ...
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
                <p className="font-['Crimson_Pro',sans-serif] font-extralight leading-[28px] relative shrink-0 text-[#555555] text-[2.5rem] text-nowrap tracking-[-1.2px] whitespace-pre">
                  $
            ...
            <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full mt-[24px]">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full pb-[16px] border-b border-[#e3e3e3]">
                <p className="font-['DM_Sans',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#555555] text-[0.875rem]">
                  Portfolio Concentration Alert
                </p>
                <p className="font-['DM_Sans',sans-serif] font-light leading-[1.5] not-italic relative shrink-0 text-[#555555] text-[0.875rem] tracking-[-0.28px] w-full">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full pb-[16px] border-b border-[#e3e3e3]">
                ...
                <ul className="ml-[16px] space-y-[4px]">
                  <li className="font-['DM_Sans',sans-serif] font-light leading-[1.5] text-[#555555] text-[0.875rem] tracking-[-0.28px] list-disc">
                ...
                <p className="font-['DM_Sans',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#555555] text-[0.875rem] tracking-[-0.28px] w-full">
