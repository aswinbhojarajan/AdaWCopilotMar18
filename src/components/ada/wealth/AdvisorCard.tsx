          ...
          <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex items-start gap-[16px] relative shrink-0 w-full">
              ...
              <div className="flex flex-col gap-[6px] flex-1">
                <p className="font-['DM_Sans',sans-serif] font-semibold leading-[normal] not-italic text-[#555555] text-[1rem]">
                  {advisorName}
                </p>
                <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic text-[#555555] text-[0.8125rem] opacity-60">
                  {advisorTitle}
                </p>
                ...
                <div className="flex items-center gap-[6px] mt-[4px]">
                  ...
                  <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic text-[#555555] text-[0.75rem]">
                    {availabilityStatus}
                  </p>
                </div>
              </div>
            ...
            <div className="content-stretch flex items-start gap-[16px] relative shrink-0 w-full pb-[16px] border-b border-[#e3e3e3]">
              <div className="flex flex-col gap-[4px] flex-1">
                <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic text-[#555555] text-[0.6875rem] opacity-60 uppercase tracking-[0.6px]">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                <div className="flex items-start gap-[8px]">
                  ...
                  <p className="font-['DM_Sans',sans-serif] font-light leading-[1.5] text-[#555555] text-[0.8125rem] tracking-[-0.26px] flex-1">
