            ...
            <div className="flex-1 flex flex-col gap-[2px]">
              ...
              {!isExpanded && (
                <p className="font-['DM_Sans:Regular',sans-serif] leading-[1.3] not-italic text-[#555555] text-[12px] opacity-60">
                  {topHoldings.map(h => h.symbol).join(', ')} · +{topHoldings[0].changePercent.toFixed(1)}% avg
                </p>
              )}
            </div>
            ...
            <>
              ...
              <div className="content-stretch flex flex-col items-start px-[24px] pb-[16px] w-full">
                <div className="mt-[12px] w-full">
                  <p className="font-['DM_Sans:SemiBold',sans-serif] text-[#992929] text-[10px] tracking-[0.8px] uppercase mb-[8px]">
