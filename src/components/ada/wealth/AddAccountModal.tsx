        ...
        <div className="px-[24px] py-[16px]">
          ...
          <div className="relative mb-[20px]">
            ...
            <input
              ...
              inputMode="search"
              autoComplete="off"
              className="w-full h-[48px] pl-[40px] pr-[16px] rounded-[50px] bg-[#f7f6f2] border border-[#d8d8d8] font-['DM_Sans',sans-serif] text-[#555555] focus:outline-none focus:border-[#555555]"
            />
          </div>
          ...
          {popularInstitutions.length > 0 && (
            <div className="mb-[20px]">
              <p className="font-['DM_Sans',sans-serif] font-semibold text-[#555555] text-[0.625rem] tracking-[0.8px] uppercase mb-[12px] opacity-60">
                Popular
              </p>
                    ...
                    <div className="flex items-center gap-[12px]">
                      ...
                      <div className="flex flex-col items-start gap-[2px]">
                        ...
                        <div className="flex items-center gap-[4px]">
                          ...
                          <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.625rem] opacity-60 capitalize">
                            {institution.type}
                          </p>
                        </div>
                      </div>
      ...
      {step === 'credentials' && selectedInstitution && (
        <div className="px-[24px] py-[16px]">
          ...
          >
            ...
            <p className="font-['DM_Sans',sans-serif] text-[0.875rem]">Back</p>
          </button>
          ...
          <div className="flex flex-col gap-[16px] mb-[24px]">
            <div>
              <label className="font-['DM_Sans',sans-serif] font-semibold text-[#555555] text-[0.75rem] mb-[8px] block">
                Username / Account ID
              </label>
              <input
                type="text"
                ...
                className="w-full h-[48px] px-[16px] rounded-[12px] bg-[#f7f6f2] border border-[#d8d8d8] font-['DM_Sans',sans-serif] text-[#555555] focus:outline-none focus:border-[#555555]"
          ...
          <div className="bg-[#fff5e6] border border-[#f59e0b] rounded-[12px] p-[12px] mb-[24px]">
            <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.75rem]">
      ...
      {step === 'connecting' && (
        <div className="px-[24px] py-[60px] flex flex-col items-center justify-center">
          <Loader2
            ...
            strokeWidth={1.5}
          />
          <p className="font-['Crimson_Pro',sans-serif] text-[#555555] text-[1.25rem] mb-[8px]">
            Connecting...
          </p>
          <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.875rem] opacity-60 text-center">
