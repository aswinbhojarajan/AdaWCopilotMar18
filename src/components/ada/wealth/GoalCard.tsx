        ...
        <div className="flex gap-[16px] items-start w-full">
          ...
          <div className="flex-1 flex flex-col gap-[8px] min-w-0">
            ...
            <div className="flex items-center gap-[8px] w-full">
              <p className="font-['Crimson_Pro',sans-serif] text-[#555555] tracking-[-0.48px] text-[1.25rem]">
                {title}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex items-baseline gap-[6px] w-full flex-wrap">
                <p className="font-['DM_Sans',sans-serif] font-semibold text-[#555555] text-[1.125rem]">
              ...
              <div className="flex flex-col gap-[2px] w-full">
                <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.8125rem]">
                  ${remaining.toLocaleString()} remaining
                </p>
                <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.6875rem] opacity-60">
                  Target: {deadline}
                </p>
                {delta !== null && (
                  <p
                    className="font-['DM_Sans',sans-serif] font-semibold text-[0.75rem] mt-[2px]"
            ...
            <div className="flex flex-col gap-[12px] w-full">
              ...
              {statusConfig && (
                ...
                >
                  ...
                  />
                  <span
                    className="font-['DM_Sans',sans-serif] font-semibold text-[0.5625rem] tracking-[0.6px] uppercase whitespace-nowrap"
              ...
              {/* Ada Panel Title */}
              <p className="font-['Crimson_Pro',sans-serif] text-[#555555] text-[1.25rem] tracking-[-0.48px]">
                Here's what changed — and 2 ways to fix it.
              </p>

              {/* Inline Copy */}
              <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.875rem] leading-[20px]">
              ...
              {recoveryOptions.map((option) => (
                ...
                >
                  <div className="flex flex-col gap-[8px] w-full">
                    ...
                    <p className="font-['Crimson_Pro',sans-serif] text-[#555555] text-[1.125rem] tracking-[-0.48px]">
                      {option.title}
                    </p>
                    <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.875rem] leading-[20px]">
                      {option.description}
          ...
          aiInsight && (
            <div className="flex flex-col gap-[20px] w-full mt-[20px]">
              ...
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <p className="font-['DM_Sans',sans-serif] text-[#555555] text-[0.875rem] leading-[20px] w-full">
                  {aiInsight}
                </p>
              </div>
