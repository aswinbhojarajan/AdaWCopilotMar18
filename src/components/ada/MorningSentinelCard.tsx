    ...
    <div className="flex items-center justify-between py-[8px]">
      <div className="flex items-center gap-[10px]">
        <div className="bg-[#f7f6f2] rounded-full size-[32px] flex items-center justify-center shrink-0">
          <span className="font-['DM_Sans:SemiBold',sans-serif] text-[10px] text-[#555555] tracking-[0.5px]">
            {mover.symbol.slice(0, 3)}
          </span>
        </div>
        <div>
          <p className="font-['DM_Sans:Regular',sans-serif] text-[13px] text-[#333333]">
            {mover.name}
          </p>
          <p className="font-['DM_Sans:Regular',sans-serif] text-[11px] text-[#888888]">
            {mover.detail}
          </p>
        </div>
      </div>
      <div className={`flex items-center gap-[4px] ${isUp ? 'text-[#03561a]' : 'text-[#c0392b]'}`}>
        ...
        <span className="font-['DM_Sans:Regular',sans-serif] text-[11px]">
          {isUp ? 'Up' : 'Down'}
        </span>
      </div>
    </div>
  ...
  return (
    <div className="flex gap-[10px] py-[6px]">
      ...
      <div className="flex-1">
        <p className="font-['DM_Sans:SemiBold',sans-serif] text-[13px] text-[#333333]">
          {risk.title}
        </p>
        <p className="font-['DM_Sans:Regular',sans-serif] text-[12px] text-[#777777] leading-[18px]">
          {risk.description}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="flex items-start justify-between gap-[12px] py-[8px]">
      ...
      >
        ...
        <span className="font-['DM_Sans:Regular',sans-serif] text-[11px] text-white whitespace-nowrap">
          {action.ctaText}
        </span>
      </button>
    </div>
  ...
  if (isError || !data) {
    return (
      <div className="bg-white rounded-[30px] w-full p-[24px]">
        <p className="font-['DM_Sans:Regular',sans-serif] text-[14px] text-[#555555] text-center">
          Unable to generate your briefing right now.
        </p>
        <button
          onClick={onRetry}
          className="mt-[12px] mx-auto block font-['DM_Sans:Regular',sans-serif] text-[13px] text-[#992929] underline"
        >
          Try again
        </button>
      </div>
      ...
      <div className="p-[24px]">
        <div className="flex flex-col gap-[16px]">
          ...
          <div className="text-center">
            <p className="font-['Crimson_Pro:Regular',sans-serif] text-[18px] text-[#555555] tracking-[-0.36px] leading-normal">
              {data.headline}
            </p>
          </div>

          <p className="font-['Crimson_Pro:Regular',sans-serif] text-[15px] text-[#555555] tracking-[-0.3px] leading-[22px] text-center opacity-70">
            {data.overview}
          </p>
          ...
          <div className="flex gap-[10px]">
            ...
            >
              ...
              <p className="font-['DM_Sans:Regular',sans-serif] text-white text-[12px] whitespace-nowrap">
                Dive deeper
              </p>
            </button>
            <button
            ...
            >
              ...
              <p className="font-['DM_Sans:Regular',sans-serif] text-[#555555] text-[12px] whitespace-nowrap">
                Weekly focus
              </p>
            </button>
          </div>
