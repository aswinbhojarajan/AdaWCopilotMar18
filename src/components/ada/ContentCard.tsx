            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full mt-[12px]">
                ...
                >
                  ...
                  <p
                    className={`font-['DM_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-nowrap whitespace-pre ${forceSecondaryButtonStyle || isNewsType ? 'text-[#555555]' : 'text-white'}`}
                  >
                    {buttonText}
                  </p>
                </button>
