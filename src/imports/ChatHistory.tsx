import svgPaths from "./svg-lsun4drcoc";
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[64px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Frame 47772" opacity="0">
          <g id="Group 37158" opacity="0">
            <path d={svgPaths.p26a22580} id="Vector" stroke="var(--stroke-0, #4C4C4C)" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.77781 20H12.2223" id="Vector 4" stroke="var(--stroke-0, #4C4C4C)" strokeLinecap="round" />
          </g>
          <path d={svgPaths.p1945c900} id="Vector_2" stroke="var(--stroke-0, #4C4C4C)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Container() {
  return (
    <div className="absolute h-[1523px] left-0 top-0 w-[375px]" data-name="Container">
      <Frame11 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center px-[8px] py-[10px] relative rounded-[50px] shrink-0">
      ...
      <p className="font-['DM_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#441316] text-[12px] text-nowrap whitespace-pre">All</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center opacity-50 px-[8px] py-[10px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#441316] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[50px]" />
      <p className="font-['DM_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#441316] text-[12px] text-nowrap whitespace-pre">Today</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center opacity-50 px-[8px] py-[10px] relative rounded-[50px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#441316] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[50px]" />
      <p className="font-['DM_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#441316] text-[12px] text-nowrap whitespace-pre">Last Week</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 px-[6px] py-0 top-[96px] w-[375px]">
      <Group1 />
    </div>
  );
}
...
export default function ChatHistory() {
  return (
    <div className="bg-[#efede6] relative size-full" data-name="Chat History">
      <Container />
      <Frame14 />
    </div>
  );
