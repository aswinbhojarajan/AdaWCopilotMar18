...
function Icon19({ children }: React.PropsWithChildren<{}>) {
  return (
    <Wrapper>
...
function Container2() {
  return (
    <Container48 additionalClassNames="bg-[#d9e2ec] size-[40px]">
      <Icon2 />
    </Container48>
  );
}
...
function Container8() {
  return (
    <Container48 additionalClassNames="bg-[#441316] size-[40px]">
      <Icon6 />
    </Container48>
  );
}
...
function Container9() {
  return (
    <Container49 additionalClassNames="h-[42.5px]">
      <Paragraph />
      <Paragraph1 />
    </Container49>
  );
...
function Icon7() {
  return (
    <div className="h-[18px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      ...
      <Icon7Vector additionalClassNames="left-3/4 right-[16.67%]" />
      <Icon7Vector additionalClassNames="left-[16.67%] right-3/4" />
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents inset-[8.33%_22.13%]" data-name="Group">
      <Group2 />
      <Group3 />
      <Group4 />
      <Group5 />
...
function Xe() {
  return (
    <div className="h-[192px] overflow-clip relative shrink-0 w-full" data-name="Xe11">
      <Group8 />
    </div>
  );
}
    ...
    >
      <div className="h-[192px] overflow-clip relative shrink-0 w-full">
        <svg viewBox="0 0 192 192" className="w-full h-full">
          ...
          <path d={createArc(0, 198, 48, 80)} fill="#1e3a8a" stroke="white" strokeWidth="2" />
          {/* Cash 20% - starts at 198, goes 72 degrees */}
          <path d={createArc(198, 270, 48, 80)} fill="#059669" stroke="white" strokeWidth="2" />
          {/* Bonds 15% - starts at 270, goes 54 degrees */}
          <path d={createArc(270, 324, 48, 80)} fill="#441316" stroke="white" strokeWidth="2" />
          {/* Crypto 6% - starts at 324, goes 21.6 degrees */}
          <path d={createArc(324, 345.6, 48, 80)} fill="#374151" stroke="white" strokeWidth="2" />
          {/* Commodities 4% - starts at 345.6, goes 14.4 degrees */}
          <path d={createArc(345.6, 360, 48, 80)} fill="#d97706" stroke="white" strokeWidth="2" />
        </svg>
      </div>
    </div>
  );
...
function Container13() {
  return (
    <Container50 additionalClassNames="w-[75.172px]">
      <Container12 />
      <TextText text="Stocks" />
    </Container50>
  );
}
...
function Container14() {
  return (
    <Wrapper3 additionalClassNames="w-[66.047px]">
      <Paragraph2 />
      <Paragraph3 />
    </Wrapper3>
  );
...
function Container17() {
  return (
    <Container50 additionalClassNames="w-[109.406px]">
      <Container16 />
      <TextText text="Crypto" />
    </Container50>
  );
}
...
function Container18() {
  return (
    <Wrapper3 additionalClassNames="w-[65.805px]">
      <Paragraph4 />
      <Paragraph5 />
    </Wrapper3>
  );
...
function Container21() {
  return (
    <Container50 additionalClassNames="w-[100.703px]">
      <Container20 />
      <TextText text="Bonds" />
    </Container50>
  );
...
function Container22() {
  return (
    <Wrapper3 additionalClassNames="w-[63.906px]">
      <Paragraph6 />
      <Paragraph7 />
    </Wrapper3>
  );
...
function Container25() {
  return (
    <Container50 additionalClassNames="w-[95.883px]">
      <Container24 />
      <TextText text="Cash" />
    </Container50>
  );
...
function Container26() {
  return (
    <Wrapper3 additionalClassNames="w-[54.883px]">
      <Paragraph8 />
      <Paragraph9 />
    </Wrapper3>
  );
...
function CommoditiesLabel() {
  return (
    <Container50 additionalClassNames="w-[130px]">
      <CommoditiesIndicator />
      <TextText text="Commodities" />
    </Container50>
  );
}
...
function CommoditiesStats() {
  return (
    <Wrapper3 additionalClassNames="w-[65px]">
...
function Container28() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[18px] py-0 relative w-full">
        <Container15 />
        <Container19 />
        <Container23 />
        <Container27 />
...
function Container29() {
  return (
    <div className="bg-white relative rounded-[20px] shrink-0 w-full" data-name="Container">
...
function Container30() {
  return (
    <Container48 additionalClassNames="bg-[#e0e7ff] size-[36px]">
      <Icon8 />
    </Container48>
  );
}
...
function Container31() {
  return (
    <Container49 additionalClassNames="h-[38px]">
      <Paragraph10 />
      <Paragraph11 />
    </Container49>
  );
...
function Container36() {
  return (
    <div className="absolute left-0 top-[114px] w-full" data-name="Container">
      <Container35 />
    </div>
  );
}
...
function TopBar() {
  return (
    <div className="absolute h-[44px] left-0 top-0 w-full" data-name="TopBar">
      <Paragraph12 />
      <Container37 />
      <Container38 />
      <Container39 />
...
function Icon16() {
  return (
    <Icon20>
      <Helper1 additionalClassNames="absolute inset-[45.83%]" />
      <Icon16Vector additionalClassNames="left-3/4 right-[16.67%]" />
      <Icon16Vector additionalClassNames="left-[16.67%] right-3/4" />
    </Icon20>
  );
}
...
function Text4() {
  return <div className="basis-0 grow h-[23.914px] min-h-px min-w-px shrink-0" data-name="Text" />;
}
