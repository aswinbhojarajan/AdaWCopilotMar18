import svgPaths from "./svg-htxx3p4b7c";
    ...
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34.6913 34.3456">
        <g clipPath="url(#clip0_174_386)" id="Group 1000011033">
          <path d={svgPaths.p11ae8b00} id="Ellipse 3627" stroke="var(--stroke-0, #555555)" />
          <path d={svgPaths.pbd88980} id="Ellipse 3628" stroke="var(--stroke-0, #555555)" />
        </g>
        <defs>
