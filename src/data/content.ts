...
export const discoverContent: Record<string, ContentItem[]> = {
  forYou: [
    {
      ...
      detailSections: [
        ...
        },
        {
          ...
          content:
            'Private equity and private credit are available options beyond your current holdings.',
        },
      ],
    },
    {
      ...
      image:
        'https://static01.nyt.com/images/2024/08/27/climate/26cli-askclimate-ai/26cli-askclimate-ai-articleLarge.jpg?quality=75&auto=webp&disable=upscale',
      detailSections: [
        {
        ...
        },
        {
          ...
          content:
            'Consider taking 20% profits from strongest performers to maintain your risk target while preserving upside potential.',
        },
      ],
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1760971439988-b236b4207d47?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnbG9iYWwlMjBidXNpbmVzcyUyMGFic3RyYWN0fGVufDF8fHx8MTc2NzYwMzQxM3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      sourcesCount: 63,
      detailSections: [
        {
        ...
        },
        {
          ...
          content:
            'Allocate 5-7% to EM bonds to boost income generation while maintaining diversification across geographies and credit quality.',
        },
      ],
    },
    {
      ...
      image:
        'https://m.wsj.net/video-atmo/20251114/768af122-9e27-4ad1-9835-a287a62d07dd/1/dynasty-header_562x1000.jpg',
      sourcesCount: 28,
      detailSections: [
        {
        ...
        },
        {
          ...
          content:
            'Work with a financial advisor to model different scenarios and choose the most tax-efficient structure.',
        },
      ],
    },
  ],
  ...
  whatsHappening: [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1766214272421-ca9354ba2cb8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxza3lsaW5lJTIwYXJjaGl0ZWN0dXJlJTIwc3Vuc2V0fGVufDF8fHx8MTc2NzYxOTYzOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      sourcesCount: 54,
    },
    {
      category: 'MARKET NEWS',
      ...
      image:
        'https://images.unsplash.com/photo-1711967152819-f493f7ab4cf5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYXJibGUlMjBidWlsZGluZyUyMGZhY2FkZXxlbnwxfHx8fDE3Njc2MTk2NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      sourcesCount: 82,
    },
    {
      category: 'MARKET NEWS',
      ...
      image:
        'https://images.unsplash.com/photo-1764675107575-7a33cbdb7905?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1cmJhbiUyMGRldmVsb3BtZW50JTIwc2t5bGluZXxlbnwxfHx8fDE3Njc2MTk2NDF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      sourcesCount: 47,
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1743352476730-056502fba10b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2xhciUyMHBhbmVscyUyMGFyY2hpdGVjdHVyZXxlbnwxfHx8fDE3Njc2MTk2NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      detailSections: [
        {
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1765850258622-9d9afa7cf4e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aW5lJTIwY2VsbGFyJTIwYm90dGxlc3xlbnwxfHx8fDE3Njc2MDk0Mjd8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      detailSections: [
        {
        ...
        },
        {
          ...
          content:
            'Professional-managed funds provide authentication, insurance, optimal storage, and quarterly liquidity windows.',
        },
      ],
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1644088379091-d574269d422f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMHRlY2hub2xvZ3klMjBuZXR3b3JrfGVufDF8fHx8MTc2NzU0Mzc1N3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      detailSections: [
        {
          title: 'Why now:',
          content: [
...
export const homeContentCards: ContentItem[] = [
  {
  ...
  },
  {
    ...
    description:
      'Because your portfolio is tilted toward growth assets, this rally is likely to deliver larger short-term gains.',
    image:
      'https://images.unsplash.com/photo-1761850167081-473019536383?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdG9jayUyMG1hcmtldCUyMGdyb3d0aCUyMGNoYXJ0fGVufDF8fHx8MTc2ODM5MDcxMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
