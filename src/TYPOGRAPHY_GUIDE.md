...
**Font:** `font-['DM_Sans',sans-serif] font-semibold`  
**Size:** `text-[10px]`  
...
<button className="content-stretch flex h-[24px] items-center justify-center px-[8px] py-[10px] relative rounded-[50px] shrink-0 opacity-50">
  ...
  <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#441316] text-[12px] text-nowrap whitespace-pre">Weekly Highlights</p>
</button>
```

### Large Display Numbers
**Usage:** Portfolio values, large financial figures  
**Font:** `font-['Crimson_Pro',sans-serif] font-extralight`  
...
**Example:**
```tsx
<p className="font-['Crimson_Pro',sans-serif] font-extralight leading-[28px] relative shrink-0 text-[#555555] text-[40px] tracking-[-1.2px]">
  $131,230.19
</p>
```
...
**Font:** `font-['Crimson_Pro',sans-serif]`  
**Weight:** `font-normal`  
**Size:** `text-[24px]`  
**Line Height:** `leading-[normal]`  
...
**Font:** `font-['DM_Sans',sans-serif] font-light`  
**Weight:** `font-light`  
**Size:** `text-[14px]`  
**Line Height:** `leading-[normal]`  
**Color:** `text-[#555555]`  
...
**Example:**
```tsx
<p className="font-['DM_Sans',sans-serif] h-[17px] leading-[28px] relative shrink-0 text-[#555555] text-[9px] text-right">
  10th Dec 2025
</p>
```
...
**Example:**
```tsx
<div className="font-['DM_Sans',sans-serif] font-light leading-[0] relative shrink-0 text-[#555555] text-[10px]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
**Example:**
```tsx
<p className="font-['DM_Sans',sans-serif] font-semibold leading-[normal] mb-0 not-italic">
...
<div className="content-stretch flex items-end justify-between not-italic relative shrink-0 w-full">
  ...
  <p className="font-['rl-limo',sans-serif] h-[12px] leading-[18px] not-italic relative shrink-0 text-[#c0180c] text-[10px] text-center tracking-[0.2px] uppercase">TODAY'S SUMMARY</p>
  <p className="font-['DM_Sans',sans-serif] h-[17px] leading-[28px] relative shrink-0 text-[#555555] text-[9px] text-right">10th Dec 2025</p>
</div>
```
...
<div className="bg-[#c6ff6a] content-stretch flex gap-[6px] h-[24px] items-center justify-center px-[8px] py-[10px] relative rounded-[50px] shrink-0">
  ...
  <p className="font-['DM_Sans',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#03561a] text-[12px] text-nowrap whitespace-pre">
    $2,210.1 (+2.44%)
  </p>
</div>
```
...
**Example:**
```tsx
<p className="absolute font-['DM_Sans',sans-serif] h-[12px] leading-[normal] not-italic text-[#555555] text-[12px]">
...
**Font:** `font-['Crimson_Pro',sans-serif] font-light`  
**Size:** `text-[40px]`, `text-[20px]`, or `text-[16px]` depending on hierarchy  
**Line Height:** `leading-[28px]`  
**Color:** `text-[#555555]`  
**Example:**
```tsx
<p className="absolute font-['Crimson_Pro',sans-serif] font-light leading-[28px] not-italic text-[#555555] text-[40px] text-nowrap whitespace-pre">
  74%
</p>
```
...
<div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
  ...
  <p className="font-['rl-limo',sans-serif] h-[14px] leading-[18px] not-italic relative shrink-0 text-[#c0180c] text-[10px] tracking-[0.2px] uppercase">
    Investors like you
  </p>
</div>
```
...
**Example:**
```tsx
<p className="font-['DM_Sans',sans-serif] font-light leading-[normal] relative shrink-0 text-[#555555] text-[12px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
...
**Example:**
```tsx
<p className="font-['rl-limo',sans-serif] h-[12px] leading-[18px] not-italic relative shrink-0 text-[#c0180c] text-[10px] text-center tracking-[0.2px] uppercase">
