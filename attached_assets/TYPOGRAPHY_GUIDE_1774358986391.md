...
### Chart Percentages (Crimson Pro Light)
**Usage:** Large percentage values in data visualizations  
**Font:** `font-['Crimson_Pro:Light',sans-serif]`  
...
**Example:**
```tsx
<p className="absolute font-['Crimson_Pro:Light',sans-serif] leading-[28px] not-italic text-[#555555] text-[40px] text-nowrap whitespace-pre">
  74%
</p>
```
