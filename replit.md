...
- **SSE event types**: `text`, `widget`, `simulator`, `suggested_questions`, `thinking`, `meta`, `structured_intent`, `structured`, `structured_error`, `disclosures`, `done`, `error`.
