...
function buildMarketQuote(
  ...
  return {
    ...
    currency: resolved.source !== 'passthrough' ? resolved.currency : (q.currency || resolved.currency || 'USD'),
  ...
  async getHistoricalPrices(
    ...
    try {
      ...
      const result = {
        ...
        display_symbol: resolved.display_name,
        provider_symbol: resolved.qualified,
        currency: resolved.source !== 'passthrough' ? resolved.currency : (data.meta?.currency || resolved.currency || 'USD'),
