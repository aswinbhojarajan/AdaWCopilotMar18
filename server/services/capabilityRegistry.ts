...
const INTENT_ROUTE_CONFIGS: Record<IntentClassification['primary_intent'], IntentRouteConfig> = {
  ...
  market_context: {
    ...
    optionalTools: ['macro_read', 'fx_read', 'identity_read'],
    description: 'Market conditions, economic indicators, macro outlook, FX rates, instrument lookup',
  },
  news_explain: {
    intent: 'news_explain',
    defaultLane: 1,
    ...
    optionalTools: ['market_read', 'research_read'],
    description: 'News headlines, company events, earnings, SEC filings, why things moved',
  },
  scenario_analysis: {
