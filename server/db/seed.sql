...
INSERT INTO discover_cards (id, card_type, tab, title, summary, detail_sections, image_url, source_count,
  ...
  ('disc-ed-1', 'wealth_planning', 'forYou',
   ...
   '[{"title":"GCC estate planning rules set for major reform in 2026","publisher":"Arabian Business","published_at":"2026-03-28T09:00:00Z","url":null,"summary":"New GCC-wide inheritance and trust regulations promise to streamline cross-border wealth transfer for HNW families."},{"title":"How trusts can cut your estate tax bill by a third","publisher":"Financial Times","published_at":"2026-03-27T14:30:00Z","url":null,"summary":"Tax advisors outline strategies using trust structures to reduce estate tax liabilities by up to 35%."},{"title":"Multi-generational wealth planning in the Gulf","publisher":"Bloomberg","published_at":"2026-03-26T11:00:00Z","url":null,"summary":"Gulf families are increasingly using sophisticated structures to preserve wealth across generations."}]',
  ...
  ('disc-ed-2', 'allocation_gap', 'forYou',
   ...
   '[{"title":"Why alternatives are essential for portfolio resilience","publisher":"CNBC","published_at":"2026-03-29T16:00:00Z","url":null,"summary":"Alternatives showed 23% lower correlation to public markets during recent volatility."},{"title":"Private equity allocations surge among GCC investors","publisher":"Gulf News","published_at":"2026-03-28T08:00:00Z","url":null,"summary":"GCC high-net-worth investors are increasing allocations to private equity and credit."},{"title":"The case for diversification beyond stocks and bonds","publisher":"Reuters","published_at":"2026-03-27T12:00:00Z","url":null,"summary":"Research shows alternative assets reduce portfolio drawdowns significantly during stress periods."}]',
  ...
  ('disc-ed-3', 'portfolio_impact', 'forYou',
   ...
   '[{"title":"AI stocks rally pushes tech sector to quarterly highs","publisher":"CNBC","published_at":"2026-03-30T18:00:00Z","url":null,"summary":"AI infrastructure and semiconductor stocks led the market higher with double-digit gains this quarter."},{"title":"Semiconductor demand surges on AI buildout","publisher":"Bloomberg","published_at":"2026-03-29T10:00:00Z","url":null,"summary":"Chip makers report record orders driven by AI data center expansion worldwide."}]',
  ...
  ('disc-ed-4', 'explainer', 'whatsNew',
   ...
   NULL,
   '[{"title":"Private credit funds attract record inflows in 2026","publisher":"Financial Times","published_at":"2026-03-28T07:00:00Z","url":null,"summary":"Private credit assets under management surpass $2 trillion as investors seek higher yields."},{"title":"Understanding the risk-return profile of direct lending","publisher":"Bloomberg","published_at":"2026-03-27T15:00:00Z","url":null,"summary":"Direct lending offers 8-12% yields with lower default rates than high-yield bonds."}]',
   TRUE, TRUE, NOW() + INTERVAL '30 days'),
  ...
  ('disc-ed-6', 'explainer', 'whatsNew',
   ...
   NULL,
   '[{"title":"ESG funds match conventional returns with lower volatility","publisher":"Financial Times","published_at":"2026-03-30T11:00:00Z","url":null,"summary":"Five-year study shows ESG-screened portfolios delivered competitive returns with 18% less volatility."},{"title":"UAE launches sustainable finance framework","publisher":"Arabian Business","published_at":"2026-03-28T14:00:00Z","url":null,"summary":"New UAE regulations encourage sustainable investing practices among financial institutions."}]',
   TRUE, TRUE, NOW() + INTERVAL '30 days')
...
INSERT INTO discover_cards (id, card_type, tab, title, summary, detail_sections, image_url, source_count,
  ...
  ('disc-prod-2', 'product_opportunity', 'forYou',
   ...
   '[{"title":"Pre-IPO tech deals offer 22-28% returns for patient capital","publisher":"Bloomberg","published_at":"2026-03-30T14:00:00Z","url":null,"summary":"Late-stage co-investments in technology companies approaching IPO deliver strong historical returns."},{"title":"Private equity co-investment opportunities expand","publisher":"CNBC","published_at":"2026-03-28T16:00:00Z","url":null,"summary":"More institutional-quality deals open to qualified investors at lower minimum tickets."}]',
   TRUE, TRUE, NOW() + INTERVAL '14 days')
ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title,
  summary = EXCLUDED.summary,
